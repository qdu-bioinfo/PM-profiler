...
int Taxa_mode = 0; //0: Retax; 1: Retax + LCA;
...
int printhelp(){
    ...
    cout << "\t  -M (upper) taxonomy mode, 0: Retax, 1: Retax + LCA, default is 0" << endl;
    ...
    cout << "\t  -S search forward and reverse strand,default is F," << endl;
